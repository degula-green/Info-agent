<template>
  <InfoConversation v-if="chat && !loadError" :chat="chat" :shared-view="sharedView" @back="router.push(backPath)" @toggle="toggleChat" @toast="toast" @share="shareSelected" @load-more="loadOlder" />
